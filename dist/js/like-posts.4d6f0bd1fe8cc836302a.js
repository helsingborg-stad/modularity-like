...
class GetPosts {
    ...
    getPosts() {
        ...
        fetch(endpoint)
            ...
            .catch(error => {
                /* eslint-disable */;(oo_oo(),console.log(error, `65ae4904_0`));
            });
    }
...
class Like {
    ...
    handleLike(likedPostsComponents) {
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _front_like__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./front/like */ "./source/js/front/like.js");
/* harmony import */ var _front_getPosts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./front/getPosts */ "./source/js/front/getPosts.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module './front/setPosts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());




const GetPostsInstance = new _front_getPosts__WEBPACK_IMPORTED_MODULE_1__["default"]();
const LikeInstance = new _front_like__WEBPACK_IMPORTED_MODULE_0__["default"]();
const SetPostsInstance = new Object(function webpackMissingModule() { var e = new Error("Cannot find module './front/setPosts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(GetPostsInstance);
})();

/******/ })()
;
//# sourceMappingURL=like-posts.4d6f0bd1fe8cc836302a.js.map