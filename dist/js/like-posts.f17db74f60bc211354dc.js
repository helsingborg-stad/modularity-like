...
class GetPosts {
    ...
    getPosts() {
        ...
        fetch(endpoint)
            ...
            .catch(error => {
                /* eslint-disable */;(oo_oo(),console.log(error, `31b09f60_0`));
            });
    }
    ...
    handlePosts(posts) {
        /* eslint-disable */;(oo_oo(),console.log("Hej", `31b09f60_1`));
...
const GetPostsInstance = new _front_getPosts__WEBPACK_IMPORTED_MODULE_0__["default"]();
const RenderInstance = new _front_render__WEBPACK_IMPORTED_MODULE_2__["default"](GetPostsInstance);
const LikeInstance = new _front_like__WEBPACK_IMPORTED_MODULE_1__["default"]();
})();

/******/ })()
;
//# sourceMappingURL=like-posts.f17db74f60bc211354dc.js.map